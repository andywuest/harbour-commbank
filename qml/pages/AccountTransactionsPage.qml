...
Page {
    ...
    property int pageSize: 20 // page size for the backend responses (20 transactions)
    ...
    function transactionsResultHandler(result) {
        ...
        hasMore = ((transactions.paging.index + pageSize) < transactions.paging.matches)
        console.log(" more transactions available : " + hasMore);
    ...
    Component.onCompleted: {
        ...
        commbankAccountService.getTransactions(accountId, startIndex);
    }
