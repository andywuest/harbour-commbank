...
const QString WALLET_COLLECTION_NAME = QStringLiteral("xx"); // TODO give final name

AccountStorageService::AccountStorageService(QObject *parent) : QObject(parent),
    secretsIdentifier(Sailfish::Secrets::Secret::Identifier(
...
void AccountStorageService::resetAccounts() {
    deleteCollection();
}
...
void AccountStorageService::storeAccountCredentials(QJsonObject accountCredentials)
{
...
void AccountStorageService::deleteAccountCredentials(const QString &accountName) {
...
QJsonObject AccountStorageService::loadAccountCredentials() {
    ...
    qDebug() << QStringLiteral("AccountStorageService::loadAccountCredentials Accounts loaded");
