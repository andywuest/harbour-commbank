...
const char URL_SESSIONS[] = "https://api.comdirect.de/api/session/clients/user/v1/sessions";
const char URL_CREATE_SESSION_TAN[] = "https://api.comdirect.de/api/session/clients/user/v1/sessions/%1/validate";
